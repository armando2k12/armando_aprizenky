package com.armando.armandoFoods.ui.home

import androidx.lifecycle.LiveData
import androidx.lifecycle.MutableLiveData
import androidx.lifecycle.ViewModel
import com.armando.armandoFoods.Callback.IBestDealLoadCallBack
import com.armando.armandoFoods.Callback.IPopularLoadCallback
...
class HomeViewModel : ViewModel(), IPopularLoadCallback, IBestDealLoadCallBack {
    ...
    private var bestDealCallbackLister: IBestDealLoadCallBack
    ...
    private fun loadBestDealList() {
        ...
        bestDealRef.addListenerForSingleValueEvent(object :ValueEventListener{
            override fun onCancelled(p0: DatabaseError) {
                bestDealCallbackLister.onBestDealLoadFailed((p0.message!!))
            }
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                bestDealCallbackLister.onBestDealLoadSucess(tempList)
            }
    ...
    private fun loadPopularList() {
        ...
        popularRef.addListenerForSingleValueEvent(object :ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                ...
                popularLoadCallbackListener.onPopularLoadSucess(tempList)
            }
    ...
    init {
        ...
        bestDealCallbackLister = this
    }

    override fun onPopularLoadSucess(popularModelList: List<PopularCategoryModel>) {
