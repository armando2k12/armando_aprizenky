...
import com.armando.armandoFoods.EventBus.*
...
class HomeActivity : AppCompatActivity() {
    ...
    private fun signOut() {
        ...
        builder.setTitle("Sign out")
            ...
            .setPositiveButton("OK"){dialodInterface,_->
    ...
    @Subscribe(sticky = true,threadMode = ThreadMode.MAIN)
    fun onHideFABEvent(event: HideFABCar)
    {
        if (event.isHide)
        {
            fab.hide()
                                ...
                                .addListenerForSingleValueEvent(object :ValueEventListener{
                                    ...
                                    override fun onDataChange(p0: DataSnapshot) {
                                        if (p0.exists())
                                        {
                                            ...
                                            {
                                                Common.foodSelected = foodSnapShot.getValue(
