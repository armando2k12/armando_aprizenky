package com.armando.armandoFoods
...
import com.armando.armandoFoods.Model.UserModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showRegisterDialog(user:FirebaseUser) {
        ...
        builder.setMessage("please fill informetion")
            ...
            userRef!!.child(user!!.uid)
                ...
                .addOnCompleteListener { task ->
                    if (task.isSuccessful)
                    {
                        ...
                        Toast.makeText(this@MainActivity, "Congratulation ! Register sucess!",Toast.LENGTH_SHORT).show()
